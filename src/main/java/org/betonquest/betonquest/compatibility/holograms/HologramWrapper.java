...
public class HologramWrapper {
    final int interval;
    public final List<BetonHologram> holograms;
    public final boolean staticContent;
    public final ConditionID[] conditionList;
    public final List<AbstractLine> cleanedLines;
     ...
     */
    public HologramWrapper(int interval, List<BetonHologram> holograms, boolean staticContent,
                           ConditionID[] conditionList, List<AbstractLine> cleanedLines, QuestPackage questPackage) {
